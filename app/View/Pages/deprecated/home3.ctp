...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-5">
            <h1><big><big><!--<i class="glyphicon glyphicon-road"></i>-->YoTeLlevo</big></big><div><small>Consigue un chofer con carro que te lleve a cualquier parte de Cuba, de la manera más fácil, cómoda y rápida. Garantizado.</small></div></h1>
        ...
        <div class="col-md-6 col-md-offset-1" style="/*margin-top:-20px*/">
            ...
            <br/>-->
            <?php echo $this->Html->link('Crea un Anuncio de Viaje y Encuentra un Chofer', 
