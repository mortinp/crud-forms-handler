...
<div class="row">
    <div class="col-md-6 col-md-offset-1">
        ...
        <legend><?php echo __('Regístrate (o ' . $this->Html->link('Entra', array('controller' => 'users', 'action' => 'login')) . ' si ya tienes una cuenta)'); ?></legend>
    ...
    <!--<div class="col-md-4 col-md-offset-1">
        ...
        <ul style="list-style-type: none;padding-left:20px">
            ...
            <li style="padding-bottom: 15px">
                <i class="glyphicon glyphicon-ok" style="margin-left: -20px"></i> 
                <b>Tu dirección de correo electrónico en ningún caso será revelada</b>.
            </li>
            <li style="padding-bottom: 15px">
                <i class="glyphicon glyphicon-ok" style="margin-left: -20px"></i> 
